#!/usr/bin/env node
// Add Component Specification <details> section to pages that are missing it.
...
for (const file of htmlFiles) {
  ...
  if (!fs.existsSync(path.join(compDir, compName, `${compName}.md`))) continue;
  ...
  // Build the spec details section
  const specSection = `
