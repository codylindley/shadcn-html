...
/* Uses ::details-content pseudo-element for smooth height animation.
   calc-size(auto, size) is implicit via `block-size: auto`.
   @starting-style enables enter transitions from the closed state. */
